...
//   const getGithubProjects = useCallback(async (publicRepoCount: number): Promise<GithubProject[]> => {
...
//                     )}
//                     <AvatarCard profile={profile} loading={loading} avatarRing={sanitizedConfig.themeConfig.displayAvatarRing} resumeFileUrl={sanitizedConfig.resume.fileUrl} />
...
//                     {sanitizedConfig.educations.length !== 0 && <EducationCard loading={loading} educations={sanitizedConfig.educations} />}
//                     {sanitizedConfig.experiences.length !== 0 && <ExperienceCard loading={loading} experiences={sanitizedConfig.experiences} />}
          ...
          <>
            ...
            <div className={`p-4 lg:p-10 min-h-full ${BG_COLOR}`}>
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 rounded-box">
                ...
                <div className="lg:col-span-2 col-span-1">
                  <div className="grid grid-cols-1 gap-6">
                    {/* ⬇️ Experience now above projects */}
