...
const CONFIG = {
  github: {
    username: 'santhoshraghu26',
    displayName: 'santhoshraghu',// Your GitHub org/user name. (This is the only required config)
  },
  /**
...
publications: [
  ...
  googleAnalytics: {
    id: 'G-MLJ0XMYCVM', // GA3 tracking id/GA4 tag id UA-XXXXXXXXX-X | G-XXXXXXXXXX
  },
